...
func (_mock *TxManager) Do(ctx context.Context, fn func(context.Context) error) error {
...
func (_c *TxManager_Do_Call) RunAndReturn(run func(ctx context.Context, fn func(context.Context) error) error) *TxManager_Do_Call {
	_c.Call.Return(run)
	return _c
}
