...
type PayOrderResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// UUID созданной транзакции (UUID v4)
...
const file_payment_v1_payment_proto_rawDesc = "" +
	...
	"\x0epayment_method\x18\x02 \x01(\x0e2\x19.payment.v1.PaymentMethodB\b\xbaH\x05\x82\x01\x02\x10\x01R\rpaymentMethod\"=\n" +
	...
	"\bPayOrder\x12\x1b.payment.v1.PayOrderRequest\x1a\x1c.payment.v1.PayOrderResponseBOZMgithub.com/PabloGolobaro/cosmic_factory/shared/pkg/proto/payment/v1;paymentv1b\x06proto3"
