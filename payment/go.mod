// TODO: Поменяй имя модуля github.com/PabloGolobaro/cosmic_factory/week_1 на своё и обнови все импорты
module github.com/PabloGolobaro/cosmic_factory/payment
