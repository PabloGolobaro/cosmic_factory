...
module github.com/PabloGolobaro/cosmic_factory/iam
...
replace (
	github.com/PabloGolobaro/cosmic_factory/platform => ../platform
	github.com/PabloGolobaro/cosmic_factory/shared => ../shared
)
